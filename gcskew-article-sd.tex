...
\newblock {\emph{\JournalTitle{Briefings in Bioinformatics}}}
  \bibinfo{pages}{bbaa041}, \url{10.1093/bib/bbaa041} (\bibinfo{year}{2020}).
...
\newblock {\emph{\JournalTitle{Journal of Molecular Evolution}}}
  ...
  \url{10.1007/s002399910029} (\bibinfo{year}{2000}).
...
\newblock {\emph{\JournalTitle{Current genomics}}}
  ...
  \url{10.2174/1389202915999140328162433} (\bibinfo{year}{2014}).
...
\newblock {\emph{\JournalTitle{PLOS Genetics}}} \textbf{\bibinfo{volume}{7}},
  \bibinfo{pages}{e1002283}, \url{10.1371/journal.pgen.1002283}
  (\bibinfo{year}{2011}).
...
\newblock {\emph{\JournalTitle{Nucleic Acids Research}}}
  ...
  \url{10.1093/nar/26.10.2286} (\bibinfo{year}{1998}).
...
\newblock {\emph{\JournalTitle{The Computer Journal}}}
  ...
  \url{10.1093/comjnl/7.4.308} (\bibinfo{year}{1965}).
...
\newblock \bibinfo{title}{Skewdb: A comprehensive database of gc and 10 other
  ...
  \url{10.5061/DRYAD.G4F4QRFR6} (\bibinfo{year}{2021}).
...
\newblock \bibinfo{title}{pandas-dev/pandas: Pandas 1.3.2},
  \url{10.5281/zenodo.5203279} (\bibinfo{year}{2021}).
...
\newblock {\emph{\JournalTitle{Nucleic Acids Research}}}
  ...
  \url{10.1093/nar/30.1.142} (\bibinfo{year}{2002}).
...
\newblock {\emph{\JournalTitle{Bioinformatics}}} \textbf{\bibinfo{volume}{19}},
  \bibinfo{pages}{593--599}, \url{10.1093/bioinformatics/btg041}
  (\bibinfo{year}{2003}).
...
\newblock {\emph{\JournalTitle{{BMC} Bioinformatics}}}
  \textbf{\bibinfo{volume}{8}}, \url{10.1186/1471-2105-8-21}
  (\bibinfo{year}{2007}).
...
\bibinfo{author}{Hubert, B.}, \bibinfo{author}{Hubert, B.} \&
  \bibinfo{author}{{Beaumont Lab}}.
\newblock \bibinfo{title}{berthubert/antonie2: Skewversion 1.0},
  \url{10.5281/ZENODO.5516524} (\bibinfo{year}{2021}).
...
\newblock {\emph{\JournalTitle{The ISME Journal}}}
  ...
  \url{10.1038/ismej.2015.107} (\bibinfo{year}{2016}).
